...
| ระดับ | แถบสี | โค้ดสี | ช่วงค่า PM 2.5 (µg/m³) | ความหมาย / สถานะ | คำแนะนำสุขภาพ (ประชาชนทั่วไป) | คำแนะนำสุขภาพ (กลุ่มเสี่ยง/ดูแลพิเศษ) |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **1** | 🔵 **สีฟ้า** | `#00b0ff` | **0 – 15.0** | **คุณภาพอากาศดีมาก (Very Good)** | ทำกิจกรรมกลางแจ้งและท่องเที่ยวได้ตามปกติ | ทำกิจกรรมกลางแจ้งและท่องเที่ยวได้ตามปกติ |
| **2** | 🟢 **สีเขียว** | `#00e676` | **15.1 – 25.0** | **คุณภาพอากาศดี (Good)** | ทำกิจกรรมกลางแจ้งและท่องเที่ยวได้ตามปกติ | ทำกิจกรรมกลางแจ้งและท่องเที่ยวได้ตามปกติ |
| **3** | 🟡 **สีเหลือง** | `#ffeb3b` | **25.1 – 37.5** | **คุณภาพอากาศปานกลาง (Moderate)** | สามารถทำกิจกรรมกลางแจ้งได้ตามปกติ | หากมีอาการเบื้องต้น (ไอ, หายใจลำบาก, ระคายเคืองตา) ควรลดเวลากิจกรรมกลางแจ้ง |
| **4** | 🟠 **สีส้ม** | `#ff9100` | **37.6 – 75.0** | **เริ่มมีผลกระทบต่อสุขภาพ (Unhealthy for Sensitive)** | ควรเฝ้าระวังสุขภาพ ลดเวลากิจกรรมกลางแจ้ง หรือสวมหน้ากากป้องกันฝุ่น | ควรลดเวลากิจกรรมกลางแจ้ง สวมหน้ากากป้องกันฝุ่น หากมีอาการผิดปกติให้รีบพบแพทย์ |
| **5** | 🔴 **สีแดง** | `#ff1744` | **75.1 ขึ้นไป (> 75.0)** | **มีผลกระทบต่อสุขภาพ (Hazardous)** | หลีกเลี่ยงกิจกรรมกลางแจ้ง สวมหน้ากาก N95 และอยู่ภายในอาคาร | หลีกเลี่ยงกิจกรรมกลางแจ้งทุกชนิด สวมหน้ากาก N95 หากมีอาการควรปรึกษาแพทย์ทันที |
